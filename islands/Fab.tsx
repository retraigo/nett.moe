          ...
          {props.nav.map((navItem) => (
            <div key={navItem.key} class="mx-auto">
              ...
              >
                ...
                <span class="rounded-full relative group p-4 w-16 h-16 bg-chaos-tertiary flex flex-row items-center">
                  ...
                  <div class="absolute -left-28 mr-4 max-w-[70rem] transition-all overflow-hidden duration-500 ease-in-out text-right lg:max-w-0 lg:group-hover:max-w-[70rem]">
